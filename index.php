...
<body>
    ...
    <main class="mainpart">
        ...
        <div class="infoIndex">
            ...
            pedestrian zone with many boutiques, cafés, and restaurants. 
            The city is well known as the first settlement in Europe 
            to be granted its own coat-of-arms.
        </div>
        <h1>Administrative division of Košice</h1>
        <table>
            <tr>
                <td>District</td>
                <td>Boroughs</td>
            ...
            <tr>
                <td>Košice I</td>
                <td>Džungľa, Kavečany, Sever, Sídlisko Ťahanovce, Staré Mesto, Ťahanovce</td>
            </tr>
            <tr>
                <td>Košice II</td>
                <td>Lorinčík, Luník IX, Myslava, Pereš, Poľov, Sídlisko KVP, Šaca, Západ</td>
            </tr>
            <tr>
                <td>Košice III</td>
                <td>Sídlisko dargovských hrdinov, Košická Nová Ves</td>
            </tr>
            <tr>
                <td>Košice IV</td>
                <td>Barca, Juh, Krásna, Nad jazerom, Šebastovce, Vyšné Opátske</td>
            </tr>
        </table>
        <h1>Transport</h1>
